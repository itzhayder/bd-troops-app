...
exports.clanInfo = {
    ...
    name: "BD.troops",
    description:
        "Use both attacks significantly or stay away from war. Happy clashing Trophy push on.... NEVER GIVE UP💪💪. STAY HOME, SAVE LIVES",
    location: {
        id: 32000026,
        name: "Bangladesh",
        isCountry: true,
...
exports.leagueGroup = {
    ...
    rounds: [
        {
            warTags: ["#2RU0QL02C", "#2RU0QL2L2", "#2RU0QYUCQ", "#2RU0QL8JY"],
        },
        {
            warTags: ["#2RU9J8JR9", "#2RU9J8CVQ", "#2RU9J8V9C", "#2RU9J90G2"],
        },
        {
            warTags: ["#2RULJY92Q", "#2RULJYPYC", "#2RULJYQ0Y", "#2RULJYYJ2"],
        },
        {
            warTags: ["#0", "#0", "#0", "#0"],
        },
